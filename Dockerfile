...
RUN echo "Target platform: $TARGETPLATFORM" && \
    ...
    curl "https://scdn.rohde-schwarz.com/ur/pws/dl_downloads/dl_application/application_notes/1dc02___rs_v/rsvisa_${RS_VISA_VERSION}_$(if [[ "$TARGETPLATFORM" =~ "arm" ]]; then echo "armhf"; else echo "amd64"; fi).deb" -o rsvisa.deb && \
    dpkg -i rsvisa.deb && \
